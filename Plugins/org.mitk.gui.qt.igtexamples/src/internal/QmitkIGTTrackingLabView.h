...
protected:
  ...
  */
  ...
  mitk::NavigationDataObjectVisualizationFilter::Pointer
    m_PermanentRegistrationFilter; ///< this filter transforms from tracking coordinates into mitk world coordinates if
                                   ///< needed it is interconnected before the FiducialEegistrationFilter
  mitk::NavigationDataObjectVisualizationFilter::Pointer m_Visualizer; ///< visualization filter
  mitk::CameraVisualization::Pointer
    m_VirtualView; ///< filter to update the vtk camera according to the reference navigation data
  ...
  mitk::NavigationData::Pointer
    m_ObjectmarkerNavigationDataLastUpdate; ///< this is the position of the object marker from the last call of
                                            ///< update(); it is used to check the difference and decide if the
                                            ///< visualization must be updated
