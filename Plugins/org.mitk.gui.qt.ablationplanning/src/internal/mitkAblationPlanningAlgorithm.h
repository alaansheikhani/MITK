...
namespace mitk
{
  ...
  public:
    ...
    void SetAdjustableParameters(int iterations,
                                 double maxAblationRadius,
                                 double minAblationRadius,
                                 double toleranceNonAblatedTumorSafetyMarginVolume);
    void SetSegmentationData(mitk::Image::Pointer segmentationImage,
                             mitk::Vector3D imageDimension,
                             mitk::Vector3D imageSpacing);
    void SetStartingPoint(mitk::Point3D startingPositionInWorldCoordinates,
