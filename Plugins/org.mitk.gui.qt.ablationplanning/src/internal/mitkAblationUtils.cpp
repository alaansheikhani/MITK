...
bool AblationUtils::CheckForNonAblatedTumorTissueWithSafetyMargin(std::vector<itk::Index<3>> &indices, //NACHFRAGEN
                                                                  mitk::Image::Pointer image,
                                                                  mitk::Vector3D &imageDimension)
{
  if (image.IsNotNull())
...
std::vector<int> AblationUtils::CalculateAblationVolumeAblatedMoreThanOnce(mitk::Image::Pointer image,
                                                                 mitk::Vector3D &imageSpacing,
                                                                 mitk::Vector3D &imageDimension)
{
  std::vector<int> volume;
                                      ...
                                      std::vector<itk::Index<3>> tumorTissueSafetyMarginIndices)
{
  ...
  s.ablationVolumeAblatedMoreThanOneTime = AblationUtils::CalculateAblationVolumeAblatedMoreThanOneTime(
    plan->GetSegmentationImage(), plan->GetImageSpacing(), plan->GetImageDimension());
  s.ablationVolumeAblatedMoreThanOnce = AblationUtils::CalculateAblationVolumeAblatedMoreThanOnce(
    plan->GetSegmentationImage(), plan->GetImageSpacing(), plan->GetImageDimension());
